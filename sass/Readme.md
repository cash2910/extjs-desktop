...
folder are mapped to the application's root namespace, 'Desktop.app'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Desktop.app' in the same way
as `"Desktop.app/sass/src"`.
